    ...
    <section className="relative flex flex-col items-center justify-center overflow-hidden px-6 py-24 text-center sm:py-32">
      ...
      <div className="relative z-10 mt-10 flex flex-col items-center gap-3 opacity-0 sm:flex-row sm:justify-center animate-fade-in [animation-delay:0.3s]">
        {isAuthenticated ? (
          <Link
            href="/boards"
            className="inline-flex items-center gap-2 rounded-xl bg-navy px-8 py-3.5 text-base font-normal font-display text-white shadow-lg shadow-navy/30 transition-all hover:bg-navy/90 hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-navy focus:ring-offset-2"
          >
            Open Theorem
            <ArrowIcon />
          </Link>
