  ...
  return (
    <div className="flex items-center gap-1.5">
      <button
        type="button"
        onClick={onReset}
        className="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white/95 text-slate-600 shadow-sm backdrop-blur transition hover:bg-slate-100 hover:text-slate-900"
      ...
      <div className="flex items-center gap-0.5 rounded-lg border border-slate-200 bg-white/95 shadow-sm backdrop-blur">
        ...
        <span
          className="min-w-[3.5rem] px-2 py-1.5 text-center text-sm font-medium text-slate-700"
        >
          {percent}%
        </span>
        <button
