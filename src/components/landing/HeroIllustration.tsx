export function HeroIllustration() {
  return (
    <svg aria-hidden="true" className="absolute inset-0 h-full w-full" viewBox="-200 -80 1000 560" preserveAspectRatio="xMidYMid meet">
      ...
      <path d="M 100 50 L 180 120" stroke="var(--color-leather)" strokeOpacity={0.4} strokeWidth="1" strokeDasharray="4 4" />
      <path d="M 80 180 L 150 260" stroke="var(--color-navy)" strokeOpacity={0.3} strokeWidth="1" strokeDasharray="4 4" />
      <path d="M 520 80 L 480 200" stroke="var(--color-leather)" strokeOpacity={0.4} strokeWidth="1" strokeDasharray="4 4" />
      <path d="M 480 240 L 380 320" stroke="var(--color-navy)" strokeOpacity={0.3} strokeWidth="1" strokeDasharray="4 4" />
      <path d="M 120 300 L 350 340" stroke="var(--color-leather)" strokeOpacity={0.4} strokeWidth="1" strokeDasharray="4 4" />
      <path d="M 250 80 L 320 140" stroke="var(--color-navy)" strokeOpacity={0.3} strokeWidth="1" strokeDasharray="4 4" />
      <path d="M 380 160 L 420 220" stroke="var(--color-leather)" strokeOpacity={0.4} strokeWidth="1" strokeDasharray="4 4" />
